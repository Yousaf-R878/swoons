    ...
    <Card className="post-card bg-white shadow-md rounded-lg overflow-hidden max-w-md mx-auto flex flex-col">
      ...
      <CardContent className="p-4 flex-grow">
        <div className="flex flex-wrap gap-2 mb-4">
          {r === 1 ? (
            <>
              <Badge className="bg-blue-100 hover:bg-blue-200 transition-colors duration-300 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">
                Badge Content
              </Badge>
              <Badge className="bg-blue-100 hover:bg-blue-200 transition-colors duration-300 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded-full">
                Badge Content
        ...
        <h1 className="text-md font-semibold">Title of the Post</h1>
